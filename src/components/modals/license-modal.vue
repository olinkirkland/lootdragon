<template>
  <div class="modal">
    <header>
      <h2>Open Game License v 1.0a</h2>
    ...
    <div class="modal__content">
      ...
      <section>
        ...
        <p>
          ...
          law, but specifically excludes Product Identity;
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          ...
          Content You are copying, modifying or distributing, and You must add
      ...
      <section>
        ...
        <p>
          ...
          Identity. You agree not to indicate compatibility or co-adaptability
      ...
      <section>
        ...
        <p>
          ...
          modify and distribute any Open Game Content originally distributed
      ...
      <section>
        ...
        <p>
          ...
          statute, judicial order, or governmental regulation then You may not
